  ...
  return (
    <div className="bg-[linear-gradient(45deg,#632EE3,#9F62F2)]">
      <div className="container2 py-20 flex flex-col items-center justify-center">
        ...
        <div className="flex flex-col lg:flex-row  gap-5 w-full max-w-[1000px] justify-between text-center items-center">
          {/* first */}
          <div className="text-white border border-gray-600 lg:border-none w-full p-4 rounded-md shadow-md lg:shadow-none">
            ...
            <h1 className="font-bold text-4xl lg:text-6xl py-4 pb-2.5">
              29.6M
            </h1>
          ...
          <div className="text-white border border-gray-600 lg:border-none w-full p-4 rounded-md shadow-md lg:shadow-none">
            ...
            <h1 className="font-bold text-4xl lg:text-6xl py-4 pb-2.5">906K</h1>
            <span className="text-sm font-medium">
          ...
          <div className="text-white border border-gray-600 lg:border-none w-full p-4 rounded-md shadow-md lg:shadow-none">
            ...
            <h1 className="font-bold text-4xl lg:text-6xl py-4 pb-2.5">132+</h1>
